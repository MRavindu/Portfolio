            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <FadeIn delay={200}>
                    <div>
                        ...
                        <p className="text-white/60 text-sm mb-6 leading-relaxed">
                            Let's connect and create something amazing to see!!!
                        </p>
                        <div className="flex flex-wrap gap-3">
                            {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                                ...
                                return Icon ? (
                                    ...
                                    <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer" />
                                    </a>
                            ) : null;
                            })}
                        </div>

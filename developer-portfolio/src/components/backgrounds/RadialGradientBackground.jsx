    ...
    hero: [
      {
        ...
        colors: [
          { color: 'rgba(255, 146, 43, 0.25)', stop: '100%' },
          { color: 'rgba(255, 146, 43, 0.45)', stop: '100%' },
          { color: 'rgba(255, 146, 43, 0.5)', stop: '100%' },
          { color: 'rgba(255, 146, 43, 0.45)', stop: '100%' },
          { color: 'rgba(255, 146, 43, 0.25) ', stop: '100%' },
        ],
...

      {
        ...
        size: 'w-[1400px] h-[1400px]',
        colors: [
          { color: 'rgba(251, 130, 17, 0.25)', stop: '100%' },
          { color: 'rgba(251, 130, 17, 0.45)', stop: '100%' },
          { color: 'rgba(251, 130, 17, 0.5)', stop: '100%' },
          { color: 'rgba(251, 130, 17, 0.45)', stop: '100%' },
          { color: 'rgba(251, 130, 17, 0.25)', stop: '100%' },
        ],

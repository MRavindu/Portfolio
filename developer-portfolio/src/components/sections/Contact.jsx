...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.name || !formData.email || !formData.message) {
            setStatus({ type: 'error', message: 'Please fill in the fields'});
            return;
        }
  ...
  return (
    <section id="contact" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overfloe-hidden">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-white/60 leading-relaxed">
                                I'm always open to discussing new projects, creative ideas, or opportunities to be part of yout vision. Feel free to reach out!
                            </p>
                        </div>
                                ...
                                {Object.entries(SOCIAL_LINKS).slice(0, 3).map(([platform, url]) => {
                                    ...
                                    return Icon ? (
                                        <a
                                            ...
                                            className="p-4 bg-white/5 rounded-xl border border-white/10 hover:white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300 group"
                                        >
